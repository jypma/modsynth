...
public:
  ...
  INLINE void     fastWriteA(uint16_t value) { transferInline(0x3000 | value); }
  INLINE void     fastWriteB(uint16_t value) { transferInline(0xB000 | value); }
  INLINE void     fastWriteAGain(uint16_t value) { transferInline(0x1000 | value); }
  INLINE void     fastWriteBGain(uint16_t value) { transferInline(0x9000 | value); }
